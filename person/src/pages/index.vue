<template>
   <div class="ind"> 
        ...
        <div class="bottom-info divider" style="text-align: center; display: block;">
            <div class="divider highlight" style="text-align: center;width:100%;font-size:16px">长按关注贤生活，尊享更多服务和商品</div>
            <img style="width: 200px;" src="../assets/images/change_xianshenghuo.jpg">
